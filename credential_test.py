'''
Password Locker Test by Aggie Muturi
...
class TestCredential(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credential("Aggie","Facebook","Facebook20")
    ...
    def test_init(self):
        ...
        '''
        self.assertEqual( self.new_credential.user_password, "Aggie")
        self.assertEqual( self.new_credential.credential_name, "Facebook" )
        self.assertEqual( self.new_credential.credential_password, "Facebook20" )
