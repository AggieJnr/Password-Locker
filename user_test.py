...
class TestUser(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual( self.new_user.user_name, "Aggie" )
    ...
    def test_find_credential(self):
        ...
        found_credential = User.find_credential("Facebook")
    ...
    def test_log_in(self):
        ...
        test_user = User("Aggie","Sam")

        test_user.save_user()

        found_credential = User.log_in("Aggie", "Jnr")
    ...
    def test_user_exist(self):
        ...
        user_exists = User.user_exist("Aggie")
